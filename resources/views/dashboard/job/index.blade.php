                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header border-0 py-5">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label font-weight-bolder text-dark">Job Info</span>

                                </h3>
                                <div class="card-toolbar">
                                    <div class="card-toolbar">

                                        <a href="{{route('job.create.id',['id'=>$clients->id])}}"
                            ...
                            <div id="table" class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            @php
                                            $name = json_decode($Jobs->name, true);
                                            $desc = json_decode($Jobs->desc, true);
                                            ...
                                            <td>{{$Jobs->date}}</td>
                                            <td>{{$Jobs->salary}}</td>
                                            <td>{{$Jobs->currency->name ?? ''}}</td>
                                            <td>{{$Jobs->JobSalary->name ?? ''}}</td>
                                            <td> @if ($Jobs->status=='active')
                                                <span class="badge badge-primary">Active</span>
                                                @elseif ($Jobs->status=='stop')
                                                <span class="badge badge-info">stop</span>
                                                @elseif ($Jobs->status=='deactive')
                                                <span class="badge badge-danger">Deactive</span>
                                                @endif
                                            </td>
                                            <td> @if ($Jobs->overnight=='active')
                                                <span class="badge badge-primary">Active</span>
                                                @elseif ($Jobs->overnight=='deactive')
                                                <span class="badge badge-danger">Deactive</span>
                                                @endif
                                            </td>
                                            <td> @if ($Jobs->health_inssurance=='active')
                                                <span class="badge badge-primary">Active</span>
                                                @elseif ($Jobs->health_inssurance=='deactive')
                                                <span class="badge badge-danger">Deactive</span>
                                                @endif
                                            </td>
                                            <td> @if ($Jobs->permission=='active')
                                                <span class="badge badge-primary">Active</span>
                                                @elseif ($Jobs->permission=='deactive')
                                                <span class="badge badge-danger">Deactive</span>
                                                @endif
                                            </td>
