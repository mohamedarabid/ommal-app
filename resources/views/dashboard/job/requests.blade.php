                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header border-0 py-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label font-weight-bolder text-dark"> {{ __('Job Requests') }}</span>
                            ...
                            <div id="table" class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        @php
                            $name = json_decode($Jobs->job->name, true);
                            ...
                            @endphp
                                ...
                                {{$name['ar'] }}
                                @endif</td>
                                        <td> @if ($Jobs->status=='accept')
                                            <span class="badge badge-primary">accept</span>
                                            @elseif ($Jobs->status=='reject')
