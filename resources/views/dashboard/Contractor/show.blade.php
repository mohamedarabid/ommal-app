                            ...
                            <div class="card-body pt-4">
                                ...
                                <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                                    <div class="symbol-label"
                                        style="background-image:url('{{ asset('images/client/' . $clients->image) }}')">
                                    </div>
                                </div>
                                <div class="body">
                            ...
                            <div class="card card-custom gutter-b">
                                ...
                                <div class="card-header border-0 py-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label font-weight-bolder text-dark">Contractor Info</span>
                                ...
                                <div class="card-body pt-0 pb-3">
                                    <div class="row clearfix">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <label>Name:</label>
                                            <input type="text"
                                                @if (session()->get('lang') == 'hb') value="{{ $first_name['hb'] . ' ' . $father_name['hb'] . ' ' . $family_name['hb'] }}"
                                @else  value="{{ $first_name['ar'] . ' ' . $father_name['ar'] . ' ' . $family_name['ar'] }}" @endif
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="datetime" name="created_at" id="created_at"
                                                value="{{ $clients->created_at }}"
                                                class="form-control form-control-solid" placeholder="Enter Disclaimer"
                                                disabled />
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input value="{{ $clients->license ?? null }}"
                                                class="form-control form-control-solid" disabled />
                                        </div>

                                        <div class="form-group col-6">
                                            <label class="form-label">company_name:</label>
                                            <input value="{{ $clients->company_name ?? null }}"
                                                class="form-control form-control-solid" disabled />
                                        </div>
                                        <div class="form-group col-6">

                                            @php
                                                $name = json_decode($clients->workType->name, true);
                                            @endphp
                                            <label class="form-label">work Type:</label>
                                            <input
                                                value="  @if (session()->get('lang') == 'hb') {{ $name['hb'] ?? null }}
                                             @else
                                        {{ $name['ar'] ?? null }} @endif"
                                                class="form-control form-control-solid" disabled />
                                        </div>
