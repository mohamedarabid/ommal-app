                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{route('index.requestsWorker',['id'=>$clients->id])}}">
                                                ...
                                                <span STYLE="font-size:10.0pt">  {{ __('Job Requests') }}</span>
                                            </a>
                                        </li>
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header border-0 py-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label font-weight-bolder text-dark"> {{ __('Worker Info') }}</span>
                            ...
                            <div id="table" class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr>
                                            <th>{{ __('ID') }}</th>
                                            <th> {{ __('magnetic card') }}</th>
                                            <th> {{ __('id card') }}</th>
                                            <th> {{ __('permission card') }}</th>
                                            <th> {{ __('bank paper') }}</th>
                                            <th> {{ __('other doc') }}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$clients->id}}</td>
                                            <td><a href="{{asset($clients->magnetic_card)}}">@if($clients->magnetic_card
                                                    !=
                                                    null)magnetic card @endif</a></td>
                                            <td><a href="{{asset($clients->id_card)}}">@if($clients->id_card != null)id
                                                    card
                                                    @endif</a></td>
                                            <td><a href="{{asset($clients->permission_card)}}">@if($clients->permission_card
                                                    != null)permission card @endif</a></td>
                                            <td><a href="{{asset($clients->bank_paper)}}">@if($clients->bank_paper !=
                                                    null)bank paper @endif</a></td>
