            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="address" class="form-control form-control-solid" placeholder="address" />

                    </div>

                    <div class="form-group col-md-6">

                        <label>address HB:</label>

                        <input type="text" id="address_hb" class="form-control form-control-solid" placeholder="address" />
                ...
                <div class="row">
                    ...
                    <div class="form-group col-4">
                        ...
                        <label class="form-label">work Filed</label>

                        <select class="form-control form-control-solid" name="work_id" id="work_id">

                            @foreach ($work as $works)
                                @php
                                    $name = json_decode($works->name, true);
                                @endphp
...
@section('scripts')
    ...
    <script>
        ...
        function performStore() {
            ...
            formData.append('address_hb', document.getElementById('address_hb').value);


            store('/cms/admin/worker', formData)
