                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header border-0 py-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label font-weight-bolder text-dark">Requests Info</span>
                            ...
                            <div id="table" class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                                ...
                                <table
                                    ...
                                    <tbody>
                                        @foreach ($TenderRequest as $Tenders)
                                        <tr>
                                            @php
                                            $name = json_decode($Tenders->tender->name, true);
                                            @endphp
                                            <td>{{$Tenders->id}}</td>
                                            ...
                                            <td>@if(session()->get('lang') == 'hb' )
                                                ...
                                                {{$name['ar'] }}
                                                @endif</td>
                                            <td>{{$Tenders->budget}}</td>

                                            <td><a href="{{asset($Tenders->file)}}">show</a></td>

                                            <td> @if ($Tenders->status=='accept')
                                                <span class="badge badge-primary">accept</span>
                                                @elseif ($Tenders->status=='reject')
                                                <span class="badge badge-danger">reject</span>
                                                @elseif ($Tenders->status=='pending')
