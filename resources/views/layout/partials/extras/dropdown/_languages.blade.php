...
<ul class="navi navi-hover py-4">
    {{-- Item --}}
    <li class="navi-item">
        <a href="{{route('dashboard.change-language',['language'=>'en'])}}" class="navi-link">
    ...
    <li class="navi-item active">
        <a href="{{route('dashboard.change-language',['language'=>'hb'])}}" class="navi-link">
            <span class="symbol symbol-20 mr-3">
                <img src="{{ asset('media/svg/flags/128-spain.svg') }}" alt=""/>
            </span>
            <span class="navi-text">Hebron</span>
        </a>
    </li>
